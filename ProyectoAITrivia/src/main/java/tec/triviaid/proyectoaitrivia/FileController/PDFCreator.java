...
public class PDFCreator {
    ...
    public void createPDF(String dest, List<String> preguntas, List<String> respuestasJugador, List<String> respuestasCorrectas, String imagePath, int comodinesUsados, float avgTime) {
        try {
            ...
            for (String pregunta : preguntas) {
                document.add(new Paragraph("- " + pregunta)
                        .setFontSize(12));
            }
